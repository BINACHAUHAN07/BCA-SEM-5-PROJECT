...
include('connection.php');
    ...
    $qry="SELECT * FROM `roundway_booking`where R_Id=$R_Id";
			...
			<br>
				<div class="main">
					<div class="form-left-w3l">
                            <label for="recipient-name" class="col-form-label">Service: RoundWay Booking</label>
                    </div>
					<div class="form-left-w3l">
				...
				<div class="main">
					...
					<div class="form-right-w3ls">
						<label for="recipient-name" class="col-form-label">First_Name : <?php echo $fnm; ?></label>
					</div>
					<div class="form-left-w3l">
                            <label for="recipient-name" class="col-form-label">Last_Name : <?php echo 	$lnm; ?></label>
                    </div>
				...
				<div class="main">
					...
					<div class="form-right-w3ls">
						<label for="recipient-name" class="col-form-label">From : <?php echo $from; ?></label>
					</div>
					<div class="form-left-w3l">
                        <label for="recipient-name" class="col-form-label">To : <?php echo $to; ?></label>
                    </div>
				...
				<div class="main">
					...
					<div class="form-right-w3ls">
						<label for="recipient-name" class="col-form-label">From Date : <?php echo $from_date; ?></label>
					</div>
					<div class="form-left-w3l">
                            <label for="recipient-name" class="col-form-label">Return Date : <?php echo $return_date; ?></label>
                    </div>
				</div>
				<br>
				<div class="main">
					...
					<div class="form-right-w3ls">
						<label for="recipient-name" class="col-form-label">From Flight Time  : <?php echo $f_time; ?></label>
					</div>
					<div class="form-left-w3l">
                            <label for="recipient-name" class="col-form-label">Return Flight Time : <?php echo $r_time; ?>:00 AM</label>
                    </div>
				</div>
				...
				<div class="main">
					...
					<div class="form-right-w3ls">
						<label for="recipient-name" class="col-form-label">Children : <?php echo 	$chil; ?></label>
					</div>
