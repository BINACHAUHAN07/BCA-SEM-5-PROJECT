...
<ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">OneWay Booking Request</li>
    </ol>
    <!-- //breadcrumbs -->
	...
	<br>
	<br>
	<h3 align="center">OneWay Booking Requst</h3>
	<br>
  ...
  <?php
     ...
     $qry= "SELECT * FROM `oneway_booking`";
...
include('connection.php');
	if(isset($_POST['approve']))
	{
		$Id=$_POST['O_Id'];
		$sts=0;
		$qry="UPDATE `oneway_booking` SET `Status` = '$sts' WHERE `O_Id` = $Id";

		$sql=mysqli_query($conn,$qry);
		if($sql)
		{
			echo "<script>alert('Request Approved Successfully');window.location.assign('oneway.php');</script>";
		}
		else
		{
	...
	if(isset($_POST['cancel']))
	{
		...
		if($sql)
		{
			echo "<script>alert('Request Canceled.......');window.location.assign('oneway.php');</script>";
		}
		else{
